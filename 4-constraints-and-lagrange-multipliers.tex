...
We would like to optimise \(f\pqty{\vb{x} \pqty{u, v}}\).

But this is straightforward -- \(f\) is now effectively in terms of \(u\) and \(v\), so we want
\begin{align*}
...
\begin{example}[Optimising Quadratic Form]
    \label{ex:optimising-quadratic-form}%
